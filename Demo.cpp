...
void Demo::DrawTexturedCube()
{
	...
	glUniform3f(objectColorLoc, 0.77f, 0.50f, 0.23f);

	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0, 0.20, 0.40));
	...
	for (int i = 0; i < 2; i++) {
		...
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(0, 0, 0 + i * 0.75));
...
int main(int argc, char** argv) {
	...
	app.Start("Basic Lighting: Phong Lighting Model", 1366, 768, false, false);
}